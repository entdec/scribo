...
module Liquid
  class Tag
    class Parser
      ...
      # --
      delegate :each, to: :@args
      delegate :key?, to: :@args
      delegate :to_h, to: :@args
      delegate :each_key, to: :@args
      delegate :each_with_object, to: :@args
      delegate :each_value, to: :@args
      delegate :values_at, to: :@args
      delegate :to_enum, to: :@args
      delegate :map, to: :@args
      delegate :[]=, to: :@args
      delegate :[], to: :@args
      delegate :merge, to: :@args
      delegate :merge!, to: :@args
      delegate :deep_merge, to: :@args
      delegate :deep_merge!, to: :@args
      delegate :select, to: :@args
      delegate :args_with_indifferent_access, to: :@args
