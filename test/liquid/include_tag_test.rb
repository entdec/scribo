...
class IncludeTagTest < ActiveSupport::TestCase
  test 'does not include non-published content from current site' do
    scribo_sites(:main).contents.create(identifier: 'menu', kind: 'text', data: 'included content', content_type: 'text/html')
  ...
  test 'includes content from current site' do
    scribo_sites(:main).contents.create(state: 'published', identifier: 'menu', kind: 'text', data: 'included content', content_type: 'text/html')
    subject = scribo_sites(:main).contents.create(kind: 'text', data: "|{%include 'menu'%}|", content_type: 'text/html')
  ...
  test 'does not include content from other site' do
    scribo_sites(:second).contents.create(state: 'published', identifier: 'menu', kind: 'text', data: 'included content', content_type: 'text/html')
    subject = scribo_sites(:main).contents.create(kind: 'text', data: "|{%include 'menu'%}|", content_type: 'text/html')
  ...
  test 'included content receives context passed from subject' do
    scribo_sites(:main).contents.create(state: 'published', identifier: 'menu', kind: 'text', data: 'hello {{dummy.dummy_attr}}', content_type: 'text/html')
