...
ActiveRecord::Schema.define(version: 20_171_029_113_551) do
  ...
  create_table 'scribo_contents', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    ...
    t.index %w[parent_id name], name: 'index_scribo_contents_on_parent_id_and_name', unique: true
    t.index ['parent_id'], name: 'index_scribo_contents_on_parent_id'
    t.index %w[scribo_site_id identifier], name: 'index_scribo_contents_identifier', unique: true
    t.index %w[scribo_site_id path], name: 'index_scribo_contents_path', unique: true
  ...
  create_table 'scribo_sites', id: :uuid, default: -> { 'uuid_generate_v4()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[scribable_type scribable_id], name: 'index_scribo_sites_on_scribable_type_and_scribable_id'
  end
